  ...
  return function (_Base) {
    ...
    _createClass$1(_class, [{
      ...
      value: function getResolvedState(props, state) {
        var resolvedState = _extends$1({}, _.compactObject(this.state), _.compactObject(this.props), _.compactObject(state), _.compactObject(props));
      ...
      value: function getDataModel(newState, dataChanged) {
        ...
        var makeDecoratedColumn = function makeDecoratedColumn(column, parentColumn) {
          var dcol = void 0;
          if (column.expander) {
            dcol = _extends$1({}, _this2.props.column, _this2.props.expanderDefaults, column);
          } else {
            dcol = _extends$1({}, _this2.props.column, column);
          }
        ...
        if (pivotBy.length) {
          ...
          var pivotColumnGroup = {
            ...
            columns: pivotColumns.map(function (col) {
              return _extends$1({}, _this2.props.pivotDefaults, col, {
                pivoted: true
              });
            })
            ...
            pivotColumnGroup = _extends$1({}, visibleColumns[pivotIndex], pivotColumnGroup);
        ...
        var addHeader = function addHeader(columns, column) {
          headerGroups.push(_extends$1({}, _this2.props.column, column, {
            columns: columns
          }));
          currentSpan = [];
        };
        ...
        if (pivotBy.length) {
          var groupRecursively = function groupRecursively(rows, keys) {
            ...
            groupedRows = groupedRows.map(function (rowGroup) {
              ...
              return _extends$1({}, rowGroup, (_extends2 = {}, _defineProperty(_extends2, subRowsKey, subRows), _defineProperty(_extends2, aggregatedKey, true), _extends2), aggregate(subRows));
            });
            return groupedRows;
          };
      ...
      value: function filterData(data, filtered, defaultFilterMethod, allVisibleColumns) {
        ...
        if (filtered.length) {
          ...
          filteredData = filteredData.map(function (row) {
            ...
            return _extends$1({}, row, _defineProperty({}, _this3.props.subRowsKey, _this3.filterData(row[_this3.props.subRowsKey], filtered, defaultFilterMethod, allVisibleColumns)));
          }).filter(function (row) {
            if (!row[_this3.props.subRowsKey]) {
              return true;
            }
...
var defaultProps = {
  ...
  TrGroupComponent: function TrGroupComponent(_ref2) {
    ...
    return React.createElement(
      'div',
      _extends$3({ className: classnames('rt-tr-group', className), role: 'rowgroup' }, rest),
      children
    );
  },
  TrComponent: function TrComponent(_ref3) {
    ...
    return React.createElement(
      'div',
      _extends$3({ className: classnames('rt-tr', className), role: 'row' }, rest),
      children
    );
  },
  ...
  TdComponent: function TdComponent(_ref5) {
    ...
    return React.createElement(
      'div',
      _extends$3({ className: classnames('rt-td', className), role: 'gridcell' }, rest),
      children
    );
  },
  ...
  LoadingComponent: function LoadingComponent(_ref10) {
    ...
    return React.createElement(
      'div',
      _extends$3({ className: classnames('-loading', { '-active': loading }, className) }, rest),
      React.createElement(
        'div',
    ...
    value: function render() {
      ...
      var recurseRowsViewIndex = function recurseRowsViewIndex(rows) {
        ...
        return [rows.map(function (row, i) {
          index += 1;
          var rowWithViewIndex = _extends$4({}, row, {
            _viewIndex: index
          });
      ...
      var finalState = _extends$4({}, resolvedState, {
        startRow: startRow,
        endRow: endRow,
        pageRows: pageRows,
        minRows: minRows,
      ...
      var makeHeaderGroup = function makeHeaderGroup(column, i) {
        ...
        var styles = _extends$4({}, column.headerStyle, theadGroupThProps.style, columnHeaderProps.style);

        var rest = _extends$4({}, theadGroupThProps.rest, columnHeaderProps.rest);
        ...
        return React.createElement(
          ...
          _extends$4({
            ...
            style: _extends$4({}, styles, flexStyles)
          }, rest),
      ...
      var makeHeaderGroups = function makeHeaderGroups() {
        ...
        return React.createElement(
          ...
          _extends$4({
            ...
            style: _extends$4({}, theadGroupProps.style, {
      ...
      var makeHeader = function makeHeader(column, i) {
        ...
        var styles = _extends$4({}, column.headerStyle, theadThProps.style, columnHeaderProps.style);

        var rest = _extends$4({}, theadThProps.rest, columnHeaderProps.rest);

        var isResizable = _.getFirstDefined(column.resizable, resizable, false);
        var resizer = isResizable ? React.createElement(ResizerComponent, _extends$4({
      ...
      var makeHeaders = function makeHeaders() {
        ...
        return React.createElement(
          ...
          _extends$4({
            ...
            style: _extends$4({}, theadProps.style, {
              minWidth: rowMinWidth + 'px'
            })
          }, theadProps.rest),
          React.createElement(
      ...
      var makeFilter = function makeFilter(column, i) {
        ...
        var styles = _extends$4({}, column.headerStyle, theadFilterThProps.style, columnHeaderProps.style);

        var rest = _extends$4({}, theadFilterThProps.rest, columnHeaderProps.rest);
      ...
      var makeFilters = function makeFilters() {
        ...
        return React.createElement(
          ...
          _extends$4({
            ...
            style: _extends$4({}, theadFilterProps.style, {
              minWidth: rowMinWidth + 'px'
            })
      ...
      var makePageRow = function makePageRow(row, i) {
        ...
        return React.createElement(
          TrGroupComponent,
          _extends$4({ key: rowInfo.nestingPath.join('_') }, trGroupProps),
          React.createElement(
            TrComponent,
            _extends$4({
            ...
            allVisibleColumns.map(function (column, i2) {
              ...
              var styles = _extends$4({}, tdProps.style, column.style, columnProps.style);

              var cellInfo = _extends$4({}, rowInfo, {
                isExpanded: isExpanded,
                column: _extends$4({}, column),
              ...
              if (cellInfo.pivoted) {
                ...
                if (isBranch) {
                  // isPivot
                  resolvedCell = _.normalizeComponent(ResolvedPivotComponent, _extends$4({}, cellInfo, {
      ...
      var makePadRow = function makePadRow(row, i) {
        ...
        return React.createElement(
          TrGroupComponent,
          _extends$4({ key: 'pad-' + i }, trGroupProps),
          React.createElement(
            TrComponent,
            {
      ...
      var makeColumnFooter = function makeColumnFooter(column, i) {
        ...
        var styles = _extends$4({}, tFootTdProps.style, column.style, columnProps.style, columnFooterProps.style);
      ...
      var makeColumnFooters = function makeColumnFooters() {
        ...
        return React.createElement(
          ...
          _extends$4({
            ...
            style: _extends$4({}, tFootProps.style, {
              minWidth: rowMinWidth + 'px'
            })
          }, tFootProps.rest),
          React.createElement(
      ...
      var makePagination = function makePagination() {
        ...
        return React.createElement(PaginationComponent, _extends$4({}, resolvedState, {
          pages: pages,
          canPrevious: canPrevious,
          canNext: canNext,
      ...
      var makeTable = function makeTable() {
        ...
        return React.createElement(
          ...
          _extends$4({
            ...
            style: _extends$4({}, style, rootProps.style)
          }, rootProps.rest),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              _extends$4({
                ...
                style: _extends$4({}, tBodyProps.style, {
                  minWidth: rowMinWidth + 'px'
                })
              }, tBodyProps.rest),
          ...
          React.createElement(LoadingComponent, _extends$4({ loading: loading, loadingText: loadingText }, loadingProps))
        );
      };
